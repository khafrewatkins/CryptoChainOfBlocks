...
class Block:
    ...
    def mine_block(last_block, data):
        ...
        # Mine a block based on the given last_block and data, until a block hash is found that meets the leading 0's or nonce 
    ...
    def genesis():
        ...
        #     GENESIS_DATA['data']
        #     )
        # ----- the code below upacks the entire GENESIS_DATA global dictionary as individual arguments
    ...
    def adjust_difficulty(last_block, new_timestamp):
        ...
        Increase the difficulty for blocks mined to quickly.
        Decrease the difficulty for blocks mined too slowly.
        """
 ...
 # debugging code between block.py and blockchain.py
def main():        
    # block = Block('foo')
    # print(block)
